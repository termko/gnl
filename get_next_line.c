...
/*   Updated: 2018/12/17 19:06:10 by ydavis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

t_gnl		*ft_newgnllst(const int fd, t_gnl **lst)
{
	t_gnl	*tmp;
...
t_gnl		*ft_fdsearch(const int fd, t_gnl **lst)
{
	t_gnl	*tmp;
...
char		*ft_newtxt(char *s1, char *s2)
{
	char	*tmp;
...
int			free_and_go(char **iter, char **line)
{
	char *tmp;
	char *end;
